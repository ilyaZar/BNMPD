...
// w_log_cbpf_d_bh
arma::vec w_log_cbpf_d_bh(const int& N, const int& DD, const arma::rowvec& y, const arma::vec& xa, const arma::uvec& id_x);
RcppExport SEXP _BNMPD_w_log_cbpf_d_bh(SEXP NSEXP, SEXP DDSEXP, SEXP ySEXP, SEXP xaSEXP, SEXP id_xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const int& >::type N(NSEXP);
    ...
    Rcpp::traits::input_parameter< const arma::vec& >::type xa(xaSEXP);
    Rcpp::traits::input_parameter< const arma::uvec& >::type id_x(id_xSEXP);
    rcpp_result_gen = Rcpp::wrap(w_log_cbpf_d_bh(N, DD, y, xa, id_x));
    return rcpp_result_gen;
END_RCPP
}
// w_log_cbpf_dm
...
// cbpf_as_d_cpp
arma::mat cbpf_as_d_cpp(const int& N, const int& TT, const int& DD, const arma::mat& y, const arma::mat& Regs_beta, const arma::vec& sig_sq_x, const arma::vec& phi_x, const arma::vec& x_r);
RcppExport SEXP _BNMPD_cbpf_as_d_cpp(SEXP NSEXP, SEXP TTSEXP, SEXP DDSEXP, SEXP ySEXP, SEXP Regs_betaSEXP, SEXP sig_sq_xSEXP, SEXP phi_xSEXP, SEXP x_rSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const int& >::type N(NSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(cbpf_as_d_cpp(N, TT, DD, y, Regs_beta, sig_sq_x, phi_x, x_r));
    return rcpp_result_gen;
END_RCPP
}
// cbpf_as_dm_cpp
...
// cbpf_as_d_cpp_par
Rcpp::List cbpf_as_d_cpp_par(const Rcpp::IntegerVector& id_par_vec, const int& N, const int& TT, const int& DD, const arma::cube& y_all, const arma::cube& Regs_beta_all, const arma::vec& sig_sq_x, const arma::vec& phi_x, const arma::cube& x_r_all);
RcppExport SEXP _BNMPD_cbpf_as_d_cpp_par(SEXP id_par_vecSEXP, SEXP NSEXP, SEXP TTSEXP, SEXP DDSEXP, SEXP y_allSEXP, SEXP Regs_beta_allSEXP, SEXP sig_sq_xSEXP, SEXP phi_xSEXP, SEXP x_r_allSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(cbpf_as_d_cpp_par(id_par_vec, N, TT, DD, y_all, Regs_beta_all, sig_sq_x, phi_x, x_r_all));
    return rcpp_result_gen;
END_RCPP
}
// cbpf_as_dm_cpp_par
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_BNMPD_w_log_cbpf_d_bh", (DL_FUNC) &_BNMPD_w_log_cbpf_d_bh, 5},
    ...
    {"_BNMPD_cbpf_as_d_cpp", (DL_FUNC) &_BNMPD_cbpf_as_d_cpp, 8},
    {"_BNMPD_cbpf_as_dm_cpp", (DL_FUNC) &_BNMPD_cbpf_as_dm_cpp, 9},
    {"_BNMPD_cbpf_as_m_cpp", (DL_FUNC) &_BNMPD_cbpf_as_m_cpp, 8},
    {"_BNMPD_cbpf_as_d_cpp_par", (DL_FUNC) &_BNMPD_cbpf_as_d_cpp_par, 9},
