...
#' @return a sample
#' @export
sample_beta_all_auto_lin_re <- function(sig_sq_x,
                                        vcm_bet_u,
                                        X,
                                        regs_z,
                                        U,
...
#' DD-dimensional latent state process and drawn from the inverse Wishart.
#'
#' @param inheritParams sample_beta_all_lin_re
#'
#' @return a sample
#' @export
sample_beta_all_lin_re <- function(sig_sq_x,
                                   vcm_bet_u,
                                   X,
                                   regs_z,
                                   U,
  ...
  for (d in 1:pe$DD) {
    ...
    pe$bet_u[id_betu_tmp, mm,
             dd_range_nn] <- sample_bet_u(pe$sig_sq_x[d, mm],
                                          ...
                                          dd_range_nn,
                                          pe$TT)
    beta_sampled <- sample_beta_all_lin_re(sig_sq_x = pe$sig_sq_x[d, mm],
